<%@page import="model.Lawyer"%>
<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1"%>
<!DOCTYPE html>
<html>
    <head>
        <% Lawyer user = (Lawyer)session.getAttribute("user_loged"); %>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-6">            
                    <div class="card mb-3" style="max-width: 540px;">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="00_resources/images/<%=user.getPhoto()%>" class="img-fluid rounded-start" alt="User Image">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <p class="card-text"><strong>Nombre:</strong> <%out.print(user.getLawyerName());%></p>
                                    <p class="card-text"><strong>Apellido:</strong> <%out.print(user.getLawyerSurname());%></p>
                                    <p class="card-text"><strong>NIF:</strong> <%out.print(user.getLawyerNif());%></p>
                                    <p class="card-text"><strong>Extensión:</strong> <%out.print(user.getPhoneExt());%></p>
                                    <form action="NewServlet1">
                                        <input type="hidden" value="<%out.print(user.getCodLawyer());%>" name="user"/>
                                        <input type="submit" class="btn btn-primary" value="Clientes"/>
                                    </form>
                                </div>
                            </div>
                        </div>
