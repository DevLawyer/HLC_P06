            ...
            <div class="row d-flex justify-content-center">
                <div class="col-10">
                    <table class="table table-striped table-hover">
                        <thead>
                            <tr>
                                <th class="dcf-txt-center" scope="col">COD</th>
                                <th class="dcf-txt-center" scope="col">DESCRIPCIÓN</th>
                                <th class="dcf-txt-center" scope="col">FECHA INICIO</th>
                                <th class="dcf-txt-center" scope="col">HORAS</th>
                                <th class="dcf-txt-center" scope="col">COSTE</th>
                            </tr>
                        </thead>
                        <%ArrayList<Issue> issueList = (ArrayList<Issue>) session.getAttribute("issue_list");
                            for(Issue issue : issueList) {%>
                                <tr>
                                    <th scope="row"><%out.print(issue.getId());%></th>
                                    <td data-label="NAME"><%out.print(issue.getIssueDescription());%></td>
                                    <td data-label="NAME"><%out.print(issue.getEntryDate());%></td>
                                    <td data-label="NAME"><%out.print(issue.getHoursNum());%></td>
                                    <td data-label="NAME"><%out.print(issue.getCost());%></td>
                                </tr>
                            <%}%>
                    </table>
                </div>
