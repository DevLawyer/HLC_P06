...
public final class home_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 Lawyer user = (Lawyer)session.getAttribute("user_loged"); 
      ...
      out.write("\" class=\"img-fluid rounded-start\" alt=\"User Image\">\n");
      out.write("                            </div>\n");
      out.write("                            <div class=\"col-md-8\">\n");
      out.write("                                <div class=\"card-body\">\n");
      out.write("                                    <p class=\"card-text\"><strong>Nombre:</strong> ");
out.print(user.getLawyerName());
      out.write("</p>\n");
      out.write("                                    <p class=\"card-text\"><strong>Apellido:</strong> ");
out.print(user.getLawyerSurname());
      out.write("</p>\n");
      out.write("                                    <p class=\"card-text\"><strong>NIF:</strong> ");
out.print(user.getLawyerNif());
      out.write("</p>\n");
      out.write("                                    <p class=\"card-text\"><strong>Extensión:</strong> ");
out.print(user.getPhoneExt());
      out.write("</p>\n");
      out.write("                                    <form action=\"NewServlet1\">\n");
      out.write("                                        <input type=\"hidden\" value=\"");
out.print(user.getCodLawyer());
      out.write("\" name=\"user\"/>\n");
      out.write("                                        <input type=\"submit\" class=\"btn btn-primary\" value=\"Clientes\"/>\n");
      out.write("                                    </form>\n");
      out.write("                                </div>\n");
      out.write("                            </div>\n");
      out.write("                        </div>\n");
