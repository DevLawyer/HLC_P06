...
public final class page1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                        <thead>\n");
      out.write("                            <tr>\n");
      out.write("                                <th class=\"dcf-txt-center\" scope=\"col\">NOMBRE</th>\n");
      out.write("                                <th class=\"dcf-txt-center\" scope=\"col\">APELLIDO</th>\n");
      out.write("                                <th class=\"dcf-txt-center\" scope=\"col\">NIF</th>\n");
      out.write("                                <th class=\"dcf-txt-center\" scope=\"col\">DIRECCIÓN</th>\n");
      out.write("                                <th class=\"dcf-txt-center\" scope=\"col\">TELÉFONO</th>\n");
      out.write("                            </tr>\n");
      out.write("                        </thead>\n");
      out.write("                        ");
ArrayList<Client> clientList = (ArrayList<Client>) session.getAttribute("client_list");
      ...
      out.write("\n");
      out.write("                                <tr>\n");
      out.write("                                    <th scope=\"row\"><a class=\"text-decoration-none fg-card\" href=\"NewServlet3?client=");
      out.print(client.getCodClient());
      out.write('"');
      out.write('>');
out.print(client.getClientName());
      out.write("</a></th>\n");
      out.write("                                    <td data-label=\"NAME\"><a class=\"text-decoration-none fg-card\" href=\"NewServlet3?client=");
      out.print(client.getCodClient());
      out.write('"');
      out.write('>');
out.print(client.getClientSurname());
      out.write("</a></td>\n");
      out.write("                                    <td data-label=\"NAME\"><a class=\"text-decoration-none fg-card\" href=\"NewServlet3?client=");
      out.print(client.getCodClient());
      out.write('"');
      out.write('>');
out.print(client.getClientNif());
      out.write("</a></td>\n");
      out.write("                                    <td data-label=\"NAME\"><a class=\"text-decoration-none fg-card\" href=\"NewServlet3?client=");
      out.print(client.getCodClient());
      out.write('"');
      out.write('>');
out.print(client.getClientAddress());
      out.write("</a></td>\n");
      out.write("                                    <td data-label=\"NAME\"><a class=\"text-decoration-none fg-card\" href=\"NewServlet3?client=");
      out.print(client.getCodClient());
      out.write('"');
      out.write('>');
out.print(client.getTelephoneNum());
      out.write("</a></td>\n");
      out.write("                                </tr>\n");
      out.write("                            ");
}
